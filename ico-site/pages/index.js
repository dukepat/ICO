...
export default function Home() {
  ...
  const [balanceOfCryptoDevToken, setBalanceOfCryptoDevTokens] = useState(zero)
  ...
  async function getBalanceOfCryptoDevToken() {
    try {
  ...
  async function getTotalTokenMinted() {
    try {
      const provider = await getProviderOrSigner();
      const tokenContract = new Contract(
        TOKEN_CONTRACT_ADDRESS,
  ...
  async function getTokensToBeClaimed() {
    try {
      ...
      if(balance === zero) {
        ...
        window.alert("You have no tokens left unclaimed!")
      } else {
        var amount = 0;
        ...
        <div>
          ...
          <div className={styles.description}>
            ...
            { walletConnected ?  (
              <div>
                <div className={styles.description}>
                  You have {utils.formatEther(balanceOfCryptoDevToken)} Crypto Dev Tokens 
                </div>
                <div className={styles.description}>
